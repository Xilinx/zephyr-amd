...
#define XILINX_ADMA_INT_ERR		(XILINX_ADMA_AXI_RD_DATA | \
					XILINX_ADMA_AXI_WR_DATA | \
					XILINX_ADMA_AXI_RD_DST_DSCR | \
					XILINX_ADMA_AXI_RD_SRC_DSCR | \
					XILINX_ADMA_INV_APB)
#define XILINX_ADMA_INT_OVRFL		(XILINX_ADMA_BYTE_CNT_OVRFL | \
					XILINX_ADMA_IRQ_SRC_ACCT_ERR | \
					XILINX_ADMA_IRQ_DST_ACCT_ERR)
#define XILINX_ADMA_INT_DONE     (XILINX_ADMA_DONE | XILINX_ADMA_DST_DSCR_DONE)
#define XILINX_ADMA_INT_EN_DEFAULT_MASK	(XILINX_ADMA_INT_DONE | \
					XILINX_ADMA_INT_ERR | \
					XILINX_ADMA_INT_OVRFL | \
...
struct __attribute__((__packed__)) dma_xilinx_adma_registers {
	...
	uint32_t reserved1[9];		/* Reserved space */
